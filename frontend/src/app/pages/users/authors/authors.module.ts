...
import { AuthoraddmanuscriptComponent } from './components/authormanuscript/components/authoraddmanuscript/authoraddmanuscript.component';
@NgModule({
    declarations: [
        AuthorsComponent,
        AuthorListComponent,
