...
@Component({
  selector: 'app-copywriterprofile',
  templateUrl: './copywriterprofile.component.html',
  styleUrls: ['./copywriterprofile.component.scss']
})
export class CopywriterprofileComponent implements OnInit, OnDestroy {
  id: number;
